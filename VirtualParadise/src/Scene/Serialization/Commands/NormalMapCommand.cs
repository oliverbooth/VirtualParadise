namespace VirtualParadise.Scene.Serialization.Commands
{
    ...
    /// </summary>
    [Command("NORMALMAP", "MASK", "TAG")]
    public class NormalMapCommand : CommandBase, ITaggedCommand
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="NormalMapCommand"/> class.
        /// </summary>
        public NormalMapCommand()
        ...
        public NormalMapCommand(IReadOnlyCollection<string> args, Dictionary<string, object> properties)
